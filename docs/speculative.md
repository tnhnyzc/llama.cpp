...
### Step 3.5 Flash MTP (`mtp`)

This fork includes experimental same-GGUF MTP support for Step 3.5 Flash models with nextn tensors.

See [Step 3.5 Flash MTP](./step35-mtp.md) for the tested command line, current limits, and runtime notes.
